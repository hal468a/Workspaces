...
{
  return max_serialized_size_ros2_pkg__action__Navigate_Goal(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_pkg__action__Navigate_Result(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_pkg__action__Navigate_Feedback(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_pkg__action__Navigate_SendGoal_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_pkg__action__Navigate_SendGoal_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_pkg__action__Navigate_GetResult_Request(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_pkg__action__Navigate_GetResult_Response(
    full_bounded, 0);
}
...
{
  return max_serialized_size_ros2_pkg__action__Navigate_FeedbackMessage(
    full_bounded, 0);
}
