...
static const _OddEvenCheck_Request_type_support_symbol_names_t _OddEvenCheck_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_pkg, srv, OddEvenCheck_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_pkg, srv, OddEvenCheck_Request)),
  }
};
...
{
  return &::ros2_pkg::srv::rosidl_typesupport_cpp::OddEvenCheck_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_pkg, srv, OddEvenCheck_Request)() {
  return get_message_type_support_handle<ros2_pkg::srv::OddEvenCheck_Request>();
}
...
static const _OddEvenCheck_Response_type_support_symbol_names_t _OddEvenCheck_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_pkg, srv, OddEvenCheck_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_pkg, srv, OddEvenCheck_Response)),
  }
};
...
{
  return &::ros2_pkg::srv::rosidl_typesupport_cpp::OddEvenCheck_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ros2_pkg, srv, OddEvenCheck_Response)() {
  return get_message_type_support_handle<ros2_pkg::srv::OddEvenCheck_Response>();
}
...
static const _OddEvenCheck_type_support_symbol_names_t _OddEvenCheck_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ros2_pkg, srv, OddEvenCheck)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ros2_pkg, srv, OddEvenCheck)),
  }
};
...
{
  return &::ros2_pkg::srv::rosidl_typesupport_cpp::OddEvenCheck_service_type_support_handle;
}
