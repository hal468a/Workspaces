...
class TurnCamera_Request(metaclass=Metaclass_TurnCamera_Request):
    ...
    def __init__(self, **kwargs):
        ...
        self.degree_turrn = kwargs.get('degree_turrn', float())
    ...
    def __eq__(self, other):
        if not isinstance(other, self.__class__):
            return False
        if self.degree_turrn != other.degree_turrn:
            return False
        return True
    ...
    @property
    def degree_turrn(self):
        """Message field 'degree_turrn'."""
        return self._degree_turrn

    @degree_turrn.setter
    def degree_turrn(self, value):
        if __debug__:
            assert \
                isinstance(value, float), \
                "The 'degree_turrn' field must be of type 'float'"
        self._degree_turrn = value
