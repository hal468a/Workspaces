...
class Init_TurnCamera_Request_degree_turrn
{
public:
  Init_TurnCamera_Request_degree_turrn()
  : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP)
  {}
  ::ros2_pkg::srv::TurnCamera_Request degree_turrn(::ros2_pkg::srv::TurnCamera_Request::_degree_turrn_type arg)
  {
    msg_.degree_turrn = std::move(arg);
...
{
  return ros2_pkg::srv::builder::Init_TurnCamera_Request_degree_turrn();
}
